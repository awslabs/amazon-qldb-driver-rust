        ...
        match tokens.next().transpose()? {
            ...
            Some(smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "ResultStream" => {
                        builder = builder.set_result_stream(
                            crate::json_deser::deser_union_crate_model_result_stream(tokens)?,
                        );
                    }
...
pub fn deser_union_crate_model_result_stream<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<crate::model::ResultStream>, smithy_json::deserialize::Error>
where
    I: Iterator<
            ...
            match tokens.next().transpose()? {
                ...
                Some(smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.to_unescaped()?.as_ref() {
                        "CommandResult" => Some(crate::model::ResultStream::CommandResult(
                            crate::json_deser::deser_structure_crate_model_command_result(tokens)?
                                .ok_or_else(|| {
                                    smithy_json::deserialize::Error::custom(
                                        "value for 'CommandResult' cannot be null",
                                    )
                                })?,
                        )),
                        _ => None,
...
pub fn deser_structure_crate_model_command_result<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<crate::model::CommandResult>, smithy_json::deserialize::Error>
where
    I: Iterator<
        Item = Result<smithy_json::deserialize::Token<'a>, smithy_json::deserialize::Error>,
    >,
{
    match tokens.next().transpose()? {
        ...
        Some(smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::CommandResult::builder();
            loop {
                match tokens.next().transpose()? {
                    Some(smithy_json::deserialize::Token::EndObject { .. }) => break,
                    Some(smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "Values" => {
                                builder = builder.set_values(
                                    crate::json_deser::deser_list_com_amazonaws_qldb_session_value_holders(tokens)?
                                );
                            }
                            "NextPageToken" => {
...
pub fn deser_list_com_amazonaws_qldb_session_value_holders<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
